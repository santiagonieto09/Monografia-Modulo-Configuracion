...
Como se muestra en la \autoref{fig:testjest}, se presentan los resultados obtenidos por el ejecutor de pruebas. El informe verifica el éxito en la ejecución de 1047 pruebas divididas en 95 suites. Esto fortalece la integridad funcional del módulo de Configuración, asegurando que la visualización de datos y la lógica de interacción funcionen adecuadamente.

    \begin{figure}[H]
    \centering%
    \includegraphics[width=0.7\textwidth, height=0.7\textheight, keepaspectratio]{Cap7/Figuras/testjest.png}    
    \caption{Reporte de ejecución de pruebas con Jest}
    \label{fig:testjest} 
    \end{figure}
