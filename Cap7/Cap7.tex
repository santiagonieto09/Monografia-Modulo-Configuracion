...
A continuación se presentan ejemplos concretos de pruebas de aceptación realizadas para validar las funcionalidades del módulo de configuración, mostrando un ejemplo en la Tabla \ref{tabla:ejemplo-prueba-aceptacion} de tipos de documentos. Debido a la extensión de todas las pruebas de aceptación de los módulos que forman parte del módulo de configuración, estas se compilarán en el siguiente enlace.
