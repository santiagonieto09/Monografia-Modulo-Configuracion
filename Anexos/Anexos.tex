...
Este anexo detalla los resultados completos de las pruebas de integración automatizadas ejecutadas con Newman, la interfaz de línea de comandos de Postman. Estas pruebas validan la funcionalidad, estabilidad y rendimiento de los submódulos del módulo de Configuración bajo múltiples iteraciones consecutivas. A continuación se presentan los resultados obtenidos al ejecutar 20 iteraciones de las colecciones de pruebas para cada submódulo.
 ...
 \textbf{Métodos de pago}: Los resultados de las 20 iteraciones en la Figura \ref{fig:metodosdepago} muestran:
    ...
    \caption{Resultados de iteraciones del submódulo Cuentas bancarias}
    ...
    \caption{Resultados de iteraciones del submódulo Impuestos}
    \label{fig:impuesto} 
    \end{figure}
    ...
    \caption{Resultados de iteraciones del submódulo Tipos de documentos}
    ...
    \caption{Resultados de iteraciones del submódulo Centro de costo}
    ...
    \caption{Resultados de iteraciones del submódulo Productos}
    \label{fig:productos} 
    \end{figure}
    ...
    \caption{Resultados de iteraciones del submódulo Terceros}
    \label{fig:terceros} 
    \end{figure}
    ...
    \caption{Resultados de iteraciones del submódulo Calendario}
    ...
    \caption{Resultados de iteraciones del submódulo Catálogo de cuentas}
    \label{fig:catalogo} 
    \end{figure}
