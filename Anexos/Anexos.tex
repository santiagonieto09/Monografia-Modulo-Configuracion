...
\begin{enumerate}
    ...
    \item \textbf{Serialización}: \texttt{RabbitTemplate} debe estar configurado con \texttt{Jackson2JsonMessageConverter} para la correcta serialización/deserialización de los mensajes.
