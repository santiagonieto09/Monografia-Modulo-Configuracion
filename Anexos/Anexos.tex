\begin{appendix}
\chapter{Anexo: Resultados de pruebas de integración con Newman} \label{AnexoNewman}
Este anexo detalla los resultados completos de las pruebas de integración automatizadas ejecutadas con Newman, la interfaz de línea de comandos de Postman. Estas pruebas validan la funcionalidad, estabilidad y rendimiento de los submódulos del módulo de Configuración bajo múltiples iteraciones consecutivas. A continuación se presentan los resultados obtenidos al ejecutar 20 iteraciones de las colecciones de pruebas para cada submódulo.
...
Este anexo documenta la arquitectura de mensajería asíncrona implementada para el submódulo de Centros de Costo, proporcionando una guía técnica para que otros microservicios puedan publicar eventos y comunicarse correctamente con este submódulo.
...
\begin{enumerate}
    ...
    \item \textbf{Serialización}: Asegurese que la clase \texttt{RabbitTemplate} esté configurada con \texttt{Jackson2JsonMessageConverter} para la correcta serialización/deserialización de los mensajes.
