...
\begin{table}[h!]
\centering
\caption{Configuración de Exchange y Cola para Tipos de Documentos}
\begin{tabular}{|l|l|}
\hline
\textbf{Parámetro} & \textbf{Valor} \\
\hline
...
\begin{table}[h!]
\centering
\caption{Estructura del DTO de Uso de Tipo de Documento}
\begin{tabular}{|l|l|l|p{5cm}|}
\hline
\textbf{Campo} & \textbf{Tipo} & \textbf{Requerido} & \textbf{Descripción} \\
\hline
...
\chapter{Anexo: Guía de Integración de Eventos RabbitMQ para Catálogo de Cuentas Contables}\label{AnexoF}
