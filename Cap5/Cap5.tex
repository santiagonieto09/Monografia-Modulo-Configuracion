...
\begin{figure}[H]    
    ...
    \caption{Diagrama de contenedores parte 1.}
...
Como complemento, la \autoref{fig:contenedor2} detalla las interacciones específicas con el módulo de Cartera, mostrando su colaboración a través de RabbitMQ para procesar eventos de uso de recursos, manteniendo coherencia mediante comunicación asíncrona.

\begin{figure}[H]    
    \centering%
    \includegraphics[width=1.0\textwidth, height=1.0\textheight, keepaspectratio]{Cap5/Figuras/contenedor2.png}    
    \caption{Diagrama de contenedores parte 2.}
    \label{fig:contenedor2}
\end{figure}
