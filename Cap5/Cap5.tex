...
\begin{figure}[h!]    
    ...
    \caption{Diagrama de contexto Catálogo de Cuentas.}
    \label{fig:Contexto}
\end{figure}
...
La descripción de cada componente y la participación del presente proyecto se encuentra en la \autoref{tab:contenedores}.
