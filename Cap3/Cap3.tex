...
\begin{figure}[h!]    
    \centering%
    \includegraphics[width=0.7\textwidth, height=0.8\textheight, keepaspectratio]{Cap3/Figuras/Diagrama General-Impuestos.png}    
...
\begin{figure}[h!]    
    \centering%
    \includegraphics[width=0.8\textwidth, height=0.8\textheight, keepaspectratio]{Cap3/Figuras/Diagrama General-Metodos de pago.png}    
...
\begin{figure}[h!]    
    \centering%
    \includegraphics[width=1.0\textwidth, height=0.8\textheight, keepaspectratio]{Cap3/Figuras/Diagrama General-Tipos de documentos.png}    
