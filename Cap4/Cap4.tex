...
A continuación, se explica detalladamente la etapa de elicitación de requisitos, en la cual se capturaron, analizaron y validaron las necesidades con los interesados.
\section{Elicitación de requisitos}

Para la correcta definición de los requisitos, este proceso se basó en una serie de actividades como captura, especificación, negociación, validación y verificación. Identificar la completitud de los requisitos es fundamental para que todos los elementos relevantes sean incorporados al sistema.



En la tarea de recopilación intervinieron los interesados mencionados en la Tabla \ref{tab:stakeholders}
