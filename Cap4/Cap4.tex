...
\section{Elicitación de requisitos}
 ...
 Para definir los requisitos fueron realizadas las actividades de captura, especificación, negociación, validación y verificación. Identificarlos correctamente es importante para asegurar que se capturen todos los requisitos relevantes.

 \subsection{Enfoque de Aprendizaje Basado en Proyectos (PBL)}

 El desarrollo del sistema contable se realizó bajo el enfoque de Aprendizaje Basado en Proyectos, metodología que permitió una mejor comprensión del dominio del negocio y de los requisitos del sistema a través de la experiencia práctica. Este enfoque se desarrolló en dos fases claramente diferenciadas que se ilustran en la Figura \ref{fig:PBL}.

 
\begin{figure}[h!]    
    \centering%
    \includegraphics[width=1.0\textwidth, height=1.0\textheight, keepaspectratio]{Cap4/Figuras/PBL.png}    
    \caption{Fases del enfoque de aprendizaje basado en proyectos.}
    \label{fig:PBL}
\end{figure}


 \begin{itemize}
\item \textbf{Fase 1 (2024-1 a 2024-2):} En esta etapa inicial, se implementaron los módulos básicos de ContApp, entre los cuales se encuentran Terceros, Impuestos, Productos y Catálogo de cuentas, que actualmente forman parte del módulo de configuración. Los grupos conformados por estudiantes y profesores colaboraron en el desarrollo de las características fundamentales del sistema, lo que facilitó la obtención de conocimientos esenciales acerca de los procedimientos contables, la organización estructural y las demandas operativas de la empresa. Esta etapa resultó esencial para crear una base firme de entendimiento del área y para determinar los requerimientos preliminares del sistema.

\item \textbf{Fase 2 (2025-1 a 2025-2):} En esta segunda fase, correspondiente a la práctica profesional, se desarrolló la versión funcional de ContAppUC. El conocimiento y experiencia adquiridos en la primera fase facilitaron una elicitación de requisitos más precisa y completa. La comprensión profunda del dominio del negocio permitió identificar requisitos que no habían sido evidentes inicialmente, mejorar la comunicación con los stakeholders y proponer soluciones más alineadas con las necesidades reales de la organización.
\end{itemize}

Esta enfoque iterativo y práctico mejoró notablemente la efectividad del proceso de elicitación de requisitos, puesto que los programadores no solo reunían datos, sino que los situaban en contexto y los verificaban mediante la interacción inmediata con el ámbito del problema. La separación en dos etapas facilitó un desarrollo paulatino de la comprensión del negocio, lo que dio lugar a una definición de requisitos más sólida y exhaustiva. En la tarea de recopilación intervinieron los interesados mencionados en la Tabla \ref{tab:stakeholders}

\input{Cap4/Tablas/stakeholders}

En la actividad de captura se utilizaron las técnicas de entrevistas, análisis documental y levantamiento de modelos de negocio. En la actividad de especificación se utilizaron las historias de usuario, criterios de aceptación y prototipos para representar los requisitos.

Durante la negociación, surgieron discrepancias entre las expectativas de los interesados, las necesidades institucionales y los requisitos propuestos, las cuales se resolvieron mediante varias sesiones de discusión. 

En la verificación, se aplicó la revisión entre pares, en la que los estudiantes presentaron las especificaciones a los directores para confirmar su corrección, integridad y claridad. Finalmente, en la validación, se expusieron los requisitos a los stakeholders para asegurar su concordancia con sus expectativas y requerimientos, incluyendo pruebas funcionales y de usuario.
...
\input{Cap4/Tablas/listaTareas.tex}
...
\input{Cap4/Tablas/historiasUsuario.tex}
