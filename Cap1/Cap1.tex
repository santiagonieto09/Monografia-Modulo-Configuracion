...
Para el desarrollo de la práctica profesional correspondiente a la etapa 2 del PBL, se realizaron entregas por fases con la modalidad de trabajo freelance. Dicho modelo se distingue por conferir al profesional la flexibilidad horaria y la capacidad de gestionar proyectos de manera independiente, permitiéndole ofrecer sus servicios y actuar conforme a los requerimientos específicos del cliente. \cite{mividalaboralFreelanceGua}. 
